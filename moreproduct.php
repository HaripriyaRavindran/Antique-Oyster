                                                ...
                                                <div class="col-12">
                                                    <div class="containercheck">
                                                        <ul class="ks-cboxtags">
                                                            ...
                                                            <div class="col-12">
                                                                <li><input type="checkbox" name="checkprice" id="checkboxPrice2" value="10000" onclick="checkboxclick(this)"><label for="checkboxPrice2">BETWEEN ₹5000 AND ₹10000</label></li>
                                                            </div>
                                                            <div class="col-12">
                                                                <li><input type="checkbox" name="checkprice" id="checkboxPrice3" value="20000" onclick="checkboxclick(this)"><label for="checkboxPrice3">BETWEEN ₹10000 AND ₹20000</label></li>
                                                            </div>
                                                            <div class="col-12">
                                                                <li><input type="checkbox" name="checkprice" id="checkboxPrice4" value="30000" onclick="checkboxclick(this)"><label for="checkboxPrice4">BETWEEN ₹20000 AND ₹30000</label></li>
                                                            </div>
                                                            <div class="col-12">
                                                                <li><input type="checkbox" name="checkprice" id="checkboxPrice5" value="40000" onclick="checkboxclick(this)"><label for="checkboxPrice5">BETWEEN ₹30000 AND ₹40000</label></li>
                                                            </div>
                                                            <div class="col-12">
                                                                <li><input type="checkbox" name="checkprice" id="checkboxPrice6" value="50000" onclick="checkboxclick(this)"><label for="checkboxPrice6">BETWEEN ₹40000 AND ₹50000</label></li>
                                                            </div>
                                                            <div class="col-12">
                                                                <li><input type="checkbox" name="checkprice" id="checkboxPrice7" value="MORE" onclick="checkboxclick(this)"><label for="checkboxPrice7">₹50000 AND MORE</label></li>
                                                            </div>
                                                        </ul>
