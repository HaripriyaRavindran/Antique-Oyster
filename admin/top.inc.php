            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="dashboard.php" > Product Details Master</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="users.php" > Users Master</a>
                  </li>
				      <li class="menu-item-has-children dropdown">
      ...
      <div id="right-panel" class="right-panel">
         <header id="header" class="header">
            <div class="top-left">
               ...
               <a class="navbar-brand" href="index.html"><h4>ANTIQUE OYSTER</h4></a>
                 <!-- 
               ...
               <div class="header-menu">
                  <div class="user-area dropdown float-right">
                     ...
                     <div class="user-menu dropdown-menu">
                        <a class="nav-link" href="reset.php"><i class="fa fa-power-off"></i>Reset password</a>
